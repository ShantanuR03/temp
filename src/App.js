			...
			<MuiThemeProvider>
				<div className="App">
					...
					<AppBar
						...
						style={{backgroundColor: 'rgb(0, 0, 0)', position: 'fixed', zIndex: 9999,}}
					/>
					<div className="App-container">
						<div style={{position: 'fixed', width: '100%', paddingTop: 64, zIndex: 8888, color: "black"}}>
							<TextField
								hintText="Type task"
							...
							>
								{columns.map((column,index) => (
									<Tab
										...
										style={{backgroundColor: "rgb(255, 0, 0, 0.75)"}}
									/>
								))}
							</Tabs>
						</div>
